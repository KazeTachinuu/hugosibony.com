...
export const BOOKMARKS = {
  ...
  DNS: [
    {
      name: "Google Flush Cache",
      url: "https://dns.google/cache",
      description: "Flush a record from Google Public DNS (8.8.8.8)",
    },
    {
      name: "Cloudflare Purge Cache",
      url: "https://one.one.one.one/purge-cache/",
      description: "Flush a record from Cloudflare DNS (1.1.1.1)",
    },
    {
      name: "Quad9 Result",
      url: "https://quad9.net/result/",
      description: "Check if a domain is blocked by Quad9 (9.9.9.9) and why",
    },
    {
      name: "Zonemaster",
      url: "https://www.zonemaster.net/",
      description: "Full DNS zone health check: delegation, DNSSEC, the works",
    },
  ],
  ...
  OSINT: [
    ...
    },
    {
      ...
      description: "French company filings and balance sheets: free, no paywall, by CYBERTRON",
    },
    {
