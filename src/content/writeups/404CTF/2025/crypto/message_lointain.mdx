...
<Callout type="note" title="1. Analyse du chiffrement" icon="search">
...
Pour déchiffrer, nous devons inverser ce processus. Pour un caractère chiffré avec l'indice $y$, nous devons trouver l'indice original $x$ tel que $2^x \equiv y \pmod{67}$. Ceci est le problème du <Term slug="discrete-log">**logarithme discret**</Term>.
...
<Callout type="note" title="2. Déchiffrement par précalcul" icon="calculator">
...
<Callout type="note" title="3. Script de déchiffrement" icon="code">
...
<Flag flag="404CTF{C0nstEllAt!0n}" />
