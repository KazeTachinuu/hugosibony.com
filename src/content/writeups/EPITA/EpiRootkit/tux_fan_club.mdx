...
Avec la commande `base64 -d .README > image.jpg` nous avons pu obtenir l'image (il fallait évidemment ne garder que la partie en base64 du `.README`).
...
Notre deuxième idée est de dézipper l'image avec `unzip image.jpg` et là, bingo !
...
Pendant qu'on vibait sur la musique, nous avons eu l'idée d'examiner le <Term slug="spectrogram">spectrogramme</Term>.
