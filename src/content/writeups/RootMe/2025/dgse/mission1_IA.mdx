...
<Callout type="note" title="Mission Objectives">

Vous êtes mandaté par Neoxis Laboratories pour récupérer leurs données compromises.

</Callout>

<Callout type="note" title="Initial Analysis">
...
<Figure src="writeups/rootme/dgse/mission1_IA/website.png" alt="NullVastation leaked data interface" caption="Compromised Data Interface" />

</Callout>

<Callout type="warn" title="Ransom Demand">
...
<Figure src="writeups/rootme/dgse/mission1_IA/chatbox_nullvastation.png" alt="NullVastation chat interface" caption="AI Chat Interface" />
...
The AI's response revealed the decryption key right after telling us it figured out we were trying to deceive it. Not so intelligent after all:
...
<Callout type="success" title="Data Decryption">
...
<Figure src="writeups/rootme/dgse/mission1_IA/flag.png" alt="Flag from Medicine_Recipes.pdf" caption="Flag from Medicine_Recipes.pdf" grid="true" />
</div>
...
<Flag flag="RM{723fa42601aaadcec097773997735895fb486be7}" />
