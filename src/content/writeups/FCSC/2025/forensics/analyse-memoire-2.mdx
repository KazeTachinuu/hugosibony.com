...
<Callout type="note" title="Analyse de l'arbre des processus" icon="sitemap">

### 1. Extraction de la hiérarchie des processus

Pour visualiser les relations parent-enfant entre les processus, nous utilisons le plugin PsTree de <Term slug="volatility">Volatility</Term> :
...
<Callout type="note" title="Analyse du contexte" icon="magnifying-glass">
...
2. **Argument DcomLaunch** :
   - Ce groupe de services gère l'activation DCOM
...
<Flag flag="FCSC{svchost.exe:936}" />
