...
<Callout type="info" title="Sujet" icon="circle-info">
...
<Callout type="note" title="1. Extraction du SSID et du BSSID" icon="wifi">
...
<Callout type="note" title="2. Extraction du compte iCloud" icon="user-circle">
...
<Callout type="success" title="3. Assemblage du flag" icon="flag">

On assemble les trois informations au format demandé :
<Flag flag="FCSC{FCSC|66:20:95:6C:9B:37|robertswigert@icloud.com}" />

</Callout>

<Callout type="info" title="4. Résumé des commandes utilisées" icon="list-ol">
