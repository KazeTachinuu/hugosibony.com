...
<Callout type="info" title="Challenge Summary" icon="circle-info">
...
<Callout type="note" title="Reconnaissance" icon="search">
...
<Callout type="note" title="Exploration & Fingerprinting" icon="lightbulb">
...
<Callout type="note" title="Song Identification via AcoustID" icon="cogs">
...
<Callout type="success" title="Flag Construction" icon="flag">

Following the format `FCSC{Artist_Title}`, the flag is:
<Flag flag="FCSC{Aya Higuchi_Wiosna}" />

</Callout>

<Callout type="info" title="Summary of Steps" icon="list-ol">
