...
<Callout type="info" title="Énoncé résumé" icon="circle-info">
...
<Callout type="note" title="Étapes de résolution" icon="list-ol">
...
<Flag flag="FCSC{f24e0ff9dc4c1c005d5f3aaac4853575-90c7d30853db0f93bc8dad28c7b62b4d}" />

</Callout>

<Callout type="info" title="Résumé" icon="clipboard-check">
...
<Callout type="info" title="Outils utilisés">
