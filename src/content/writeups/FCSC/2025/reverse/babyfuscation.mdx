...
<Callout type="info" title="Initial Recon" icon="circle-info">
...
<Callout type="note" title="Static Analysis with radare2" icon="search">

I use <Term slug="radare2">radare2</Term> for the static-analysis pass - disassembly, function discovery, cross-references.
...
<Callout type="note" title="Finding the Flag Check" icon="lightbulb">
...
<Callout type="note" title="Finding How User Input is Handled" icon="cogs">
...
<Callout type="note" title="Finding Input Transformation" icon="code">
...
<Callout type="note" title="Finding the Target Buffer" icon="database">
...
ec f1 24 cb 72 05
```
- This is the buffer your transformed input must match. The final `0xf1` is the string terminator (no printable preimage), so we stop one byte short.

</Callout>

<Callout type="note" title="Reversing the Transformation" icon="key">
...
<Callout type="success" title="Final Flag" icon="flag">

<Flag flag="FCSC{e30f46b147e7a25a7c8b865d0d895c7c7315f69582f432e9405b6d093b6fb8d3}" />

</Callout>

<Callout type="info" title="Summary Table" icon="table">
