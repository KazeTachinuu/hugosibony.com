...
Le challenge consiste à décoder un flag transmis via la position d'un servomoteur, contrôlé par un signal <Term slug="pwm">PWM</Term> capturé dans `mechanical-display.vcd` (un dump <Term slug="vcd">VCD</Term>). Une image de datasheet fournit la correspondance entre l'angle du servo et les caractères.

<Figure src="writeups/fcsc/2025/hardware/mechanical/mechanical.png" alt="Datasheet: correspondance entre l'angle du servomoteur et les caractères" />
