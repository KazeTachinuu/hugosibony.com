...
Nous devons reconstruire un signal vidéo <Term slug="pal-composite">PAL composite</Term> à partir d'un fichier binaire contenant un flux échantillonné à 20 MHz. Le signal contient une image avec le flag.
...
<Flag flag="FLAG{T3MP3ST_F0R3V3R}" />
