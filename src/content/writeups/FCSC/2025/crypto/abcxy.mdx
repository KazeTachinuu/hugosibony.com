...
$$
D = 24 \times 159 \times 487 \times 78\,407 = 145\,710\,941\,544
$$
...
C'est une <Term slug="pell-equation">**équation de Pell-Fermat**</Term> classique.
...
Pour résoudre l'équation de Pell $t^2 - D w^2 = 1$, on utilise la méthode des <Term slug="continued-fractions">fractions continues</Term> pour trouver la solution fondamentale $(t_1, w_1)$, puis on génère les solutions suivantes par récurrence :
