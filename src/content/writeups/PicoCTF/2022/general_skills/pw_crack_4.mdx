...
categories: "General"
difficulty: "⭐"
description: "Scripted brute-force over a larger password list with hash verification."
date: 2024-05-12T00:00:00Z
updated: 2026-07-13
draft: false
files:
  - { name: "level4.py", path: "/writeups/picoctf/2022/general_skills/pw_crack_4/level4.py" }
  - { name: "level4.flag.txt.enc", path: "/writeups/picoctf/2022/general_skills/pw_crack_4/level4.flag.txt.enc" }
  - { name: "level4.hash.bin", path: "/writeups/picoctf/2022/general_skills/pw_crack_4/level4.hash.bin" }
  - { name: "solve.py", path: "/writeups/picoctf/2022/general_skills/pw_crack_4/solve.py" }
---
