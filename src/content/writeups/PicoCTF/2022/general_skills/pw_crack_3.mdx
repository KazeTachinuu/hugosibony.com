...
categories: "General"
difficulty: "⭐"
description: "Brute-forcing a password from a small candidate list against a hash check."
date: 2024-05-12T00:00:00Z
updated: 2026-07-13
draft: false
files:
  - { name: "level3.py", path: "/writeups/picoctf/2022/general_skills/pw_crack_3/level3.py" }
  - { name: "level3.flag.txt.enc", path: "/writeups/picoctf/2022/general_skills/pw_crack_3/level3.flag.txt.enc" }
  - { name: "level3.hash.bin", path: "/writeups/picoctf/2022/general_skills/pw_crack_3/level3.hash.bin" }
  - { name: "solve.py", path: "/writeups/picoctf/2022/general_skills/pw_crack_3/solve.py" }
---
...
This challenge is here to introduce us to hashing. Whereas in the two previous ones we could read the password straight from the checking code, this one uses MD5 to hash the password. Thankfully the source code provides a list of passwords:
...
As we are told one of the 7 passwords is correct, we just write a function that tests all of them until one matches the hash.

</Callout>

<Callout type="tip" title="Solution Approach">
...
<Callout type="success" title="Implementation">
